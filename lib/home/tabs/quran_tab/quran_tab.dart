    ...
    return Scaffold(
      body: Column(
        ...
        children: [
               Expanded(
                 flex: 1,
                 child: Image(image: AssetImage("assets/images/icon_quran.png"),
              ),
               ),
          Container(
          ...
          Expanded(
            ...
            child: ListView.separated(itemBuilder: (context, index) =>
               suraTitleWidget(SuraTitleWidget: suraNames[index], versNumber: versesNumber[index].toString(), index: index, ),
